...
export class AppComponent {
  ...
  constructor(public serverService: ServerService,
    ...
    this.socketService.isReady.subscribe((v) => {
      v && this.showCreateUserModal()
    });
  }

  readonly mainModal: string = "main_modal"

  showCreateServerModal() {
    const modal = document.getElementById(this.mainModal) as HTMLDialogElement;
